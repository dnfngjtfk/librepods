...
class DeviceInfo : public QObject
{
    ...
    Q_PROPERTY(QString leftPodIcon READ leftPodIcon CONSTANT)
    Q_PROPERTY(QString rightPodIcon READ rightPodIcon CONSTANT)
...
public:
    explicit DeviceInfo(QObject *parent = nullptr) : QObject(parent), m_battery(new Battery(this)), m_earDetection(new EarDetection(this)) {
        ...
        connect(m_battery, &Battery::batteryStatusChanged, this, &DeviceInfo::caseIconChanged);
    }
    ...
    QString leftPodIcon() const { return "ProxCard_L@3x.png"; }
    QString rightPodIcon() const { return "ProxCard_R@3x.png"; }
    QString caseIcon() const
    {
        return m_battery->isCaseCharging() ? "ProxCard_case-closed-charging@3x.png" : "ProxCard_case-closed-charged@3x.png";
    }
